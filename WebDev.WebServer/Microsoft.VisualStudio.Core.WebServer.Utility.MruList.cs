namespace Microsoft.VisualStudio.Core.WebServer.Utility
{
    using System;
    ...
    public sealed class MruList : ICollection, IEnumerable
    {
        ...
        public MruList(int maxEntries) : this(maxEntries, null)
        {
        }

        public MruList(int maxEntries, string[] initialEntries)
        {
        ...
        public void AddEntry(string entry)
        {
            ...
            if (this._mruEntryCount > 0)
            {
                ...
                {
                    if (string.Compare(this._mruEntries[index], entry, StringComparison.OrdinalIgnoreCase) == 0)
                    {
                        break;
                    }
                    index++;
